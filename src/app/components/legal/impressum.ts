      ...
      <div class="legal-container">
        ...
        <div class="legal-body">
          ...
          @if (lang() === 'de') {
            ...
            <h2>Urheberrecht</h2>
            <p>
              Quellcode steht unter der jeweils im GitHub-Repository angegebenen Open-Source-Lizenz.
              Texte, Grafiken und Bildschirmaufnahmen dieser Website unterliegen, soweit nicht anders
              gekennzeichnet, dem Urheberrecht des Anbieters.
            </p>
          } @else {
            <h2>Operator</h2>
            <p>
